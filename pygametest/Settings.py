SOFTWARE_NAME = 'Prototype'     # 软件名称。
SOFTWARE_VERSION = 'v1.0'       # 软件版本。
...
WINDOW_WIDTH = BOARD_WIDTH + INFO_WIDTH     # 窗口长度。
WINDOW_HEIGHT = BOARD_HEIGHT      # 窗口宽度。

TITLE_X = WINDOW_WIDTH // 2     # 标题 x 轴所在位置。
TITLE_Y = WINDOW_HEIGHT // 4    # 标题 y 轴所在位置。
# CONSTANT